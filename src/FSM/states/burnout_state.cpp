...
const int burnout_time = 19000; // Milliseconds the rough estimate of how long the motor will burn
...
int burnout_state(double data[]) {
	...
	burntime = data[0] - launchTime;

	//if acc_z is negative but increasing
	if(data[2] > last_acc_z && last_acc_z < 0){
