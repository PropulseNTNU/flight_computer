...
const Matrix<2,2> Q={300,0 ,0 ,0.000000001};
const float R=1000; //Litt usikker på om R skal være en matrise eller en skalar. trodde egentlig den skulle være en matrise.
const Matrix<2,2> I={1,0,0,1};
Matrix<2,2> P_k_bar={1,0,0.1,0};
Matrix<2,1>x_hat_bar={0,280};// skal egentlig være ca.{2000,300};
Matrix<2,1> x_hat;//= {3000,300};
Matrix<2,1> K_k;
Matrix<2,1> Z;
Matrix<2, 2> P_k;
