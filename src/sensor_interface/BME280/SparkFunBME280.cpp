...
void BME280::printSensorInformation(bool alt, bool pres, bool temp, bool hum){
	if (alt){
    Serial.print(" Alt: ");
    Serial.print(readFloatAltitudeMeters(), 1);
    Serial.print(" [m] ");
  	}
  	if (pres){
    Serial.print(" Pressure: ");
    Serial.print(readFloatPressure(), 0);
    Serial.print(" [Pa] ");
  	}
  	if (temp){
    Serial.print(" Temp: ");
    ...
    Serial.print(readFloatHumidity(), 0);
  	}
  	Serial.println();
}